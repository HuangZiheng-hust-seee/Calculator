...
namespace calculator
{
    public partial class Form1 : Form
    {
        ...
        private void equal_Click(object sender, EventArgs e)
        {
            ...
            //插入数据
            string sqlStr = @"insert into jieguo (value) values(@userName)";
            MySqlParameter[] para = new MySqlParameter[]
               {
                    new MySqlParameter("@userName",enddata+num.Peek())
               };
            if (WindowsFormsApp1.MySqlHelper.ExecSql(sqlStr, para))
            {
